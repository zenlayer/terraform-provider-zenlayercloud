...
page_title: "ZenlayerCloud: zenlayercloud_zec_dhcp_options_set_attachment"
sidebar_current: "docs-zenlayercloud-resource-zec_dhcp_options_set_attachment"
description: |-
...
* `dhcp_options_set_id` - (Required, String, ForceNew) DHCP options set ID.
