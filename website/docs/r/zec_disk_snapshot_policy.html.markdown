...
* `name` - (Optional, String) The name of the snapshot policy. The name should start and end with a number or a letter, containing 2 to 63 characters. Only letters, numbers, - and periods (.) are supported. Default is `Terraform-Snapshot-Policy`.
