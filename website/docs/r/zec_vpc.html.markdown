...
* `enable_ipv6` - (Optional, Bool) Whether to enable the private IPv6 network segment. Default is `false`. Once the ipv6 is enabled, disable it will cause the resource to `ForceNew`.
* `mtu` - (Optional, Int, ForceNew) The maximum transmission unit. Valid values: `1300`, `1500`, `9000`. Default is `1500`. This value cannot be changed after creation.
* `name` - (Optional, String) The name of the global VPC. Default is `Terraform-Global-VPC`.
