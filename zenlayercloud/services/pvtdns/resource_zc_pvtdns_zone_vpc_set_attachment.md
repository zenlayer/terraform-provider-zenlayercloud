...
```hcl
resource "zenlayercloud_pvtdns_zone" "foo" {
...
```hcl
resource "zenlayercloud_pvtdns_vpc_set_attachment" "foo" {
  zone_id = zenlayercloud_pvtdns_zone.foo.id
...
```
$ terraform import zenlayercloud_pvtdns_vpc_set_attachment.foo zone-id
```
