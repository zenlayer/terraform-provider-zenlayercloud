...
```hcl
data "zenlayercloud_zec_zones" "all" {
}
...
//
//func DataSourceZenlayerCloudZecZones() *schema.Resource {
//	return &schema.Resource{
//		ReadContext: dataSourceZenlayerCloudZecZonesRead,
//
...
//}
//
//func dataSourceZenlayerCloudZecZonesRead(ctx context.Context, d *schema.ResourceData, meta interface{}) diag.Diagnostics {
//	defer common.LogElapsed(ctx, "data_source.zenlayercloud_zec_zones.read")()
//
//	vmService := VmService{
